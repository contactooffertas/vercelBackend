...
const serviceProviderSchema = new mongoose.Schema({
  ...
  serviceArea: { type: String, enum: ['technical','care','general'], default: 'technical' },
  careSettings: [{ type: String, enum: ['home','hospital','clinic','overnight','hourly'] }],
  professionalRegistration: { type: String, default: '', trim: true, maxlength: 80, select: false },
  ...
  pricingUnit: { type: String, enum: ['hour','visit','shift','day'], default: 'visit' },
